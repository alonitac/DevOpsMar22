docker run --name jenkins -u root --rm -d -p 8080:8080 -v jenkins-data:/var/jenkins_home \
...
# -d    Runs the jenkins/jenkins container in the background ("detached" mode)
# -p    Makes (i.e. "publishes") port 8080 of the jenkins/jenkins container to port 8080 on the
